...
env.ELASTICSEARCH_IP = "x.x.x.x"
env.EXECUTION_ID=env.BUILD_TAG
env.NODE_LABEL='CHRIS'

def utils = fileLoader.fromGit('src/JenkinsfileUtils',
			       'ipaddess/ming.lu/pipeline-shared-libs.git',
			       'release_0.1.0',
			       'null',
			       '')
...
utils.wrappedPipeline {
  utils.checkout('ipaddress/template/container.git', 'f9dd9169-e5a1-4c35-a4f7-2d329854a49b')
